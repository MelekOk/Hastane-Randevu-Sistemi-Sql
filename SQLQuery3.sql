...
--Hata ayýklamak için try catch kullanýldý.
begin try
--Ýþlemde hata oluþursa geri almak için tran kullanýldý.
...
--Update iþlemi için proc oluþturuldu
...
--Delete iþlemi için proc oluþturuldu
...
exec HastalarUpdateIslemi 2,'Gamze','Yýldýz','12345678905',29,'Kadýn'
...
exec DepartmanInsertIslemi 'Kulak Burun Boðaz'
...
--Güncelleme iþlemi için proc oluþturuldu
...
begin
    ...
    begin try
		...
		begin
		-- Ýþlemde hata oluþursa geri almak için transaction kullanýldý.
        begin tran IslemControl
